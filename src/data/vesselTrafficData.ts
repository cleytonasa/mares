...
export const INITIAL_VESSELS: VesselAIS[] = [
  ...
  {
    id: 'vsl_navio_clipper_bari',
    name: 'CLIPPER BARI STAR',
    type: 'navio',
    typeName: 'Navio Graneleiro (Handysize / Bulk Carrier)',
    mmsi: '538008899',
    callSign: 'V7A4921',
    imo: 'IMO 9613848',
    flag: '🇲🇭 Ilhas Marshall',
    ...
    beamMeters: 28,
    status: 'Operando no TERMISA',
    destination: 'TERMISA / EXPORTAÇÃO',
    eta: 'Atracado (24/08 14:00)',
    vhfChannel: 'Canal 16 / 12',
    lastAisUpdate: 'Tempo Real',
    cargo: 'Carregando 36.150 Tons de Sal Marinho (SALINOR - EXP)',
  },
  {
    id: 'vsl_navio_gannet_bulker',
    name: 'GANNET BULKER',
    type: 'navio',
    ...
    eta: '27/08/2026 11:00',
    vhfChannel: 'Canal 16',
    lastAisUpdate: 'Tempo Real',
    cargo: 'Navio em Lastro para Embarque de Sal (45.780 Tons)',
  },
  {
